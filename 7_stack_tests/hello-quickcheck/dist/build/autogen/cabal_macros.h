...
/* package hello-quickcheck-0.1.0.0 */
#define VERSION_hello_quickcheck "0.1.0.0"
#define MIN_VERSION_hello_quickcheck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hello-quickcheck-0.1.0.0-L3uzwPU8QDLHAKnLz5cWOg"

#define CURRENT_PACKAGE_KEY "hello-quickcheck-0.1.0.0-L3uzwPU8QDLHAKnLz5cWOg"
